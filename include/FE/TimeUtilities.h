#ifndef __TIMEUTILITIES__
#define __TIMEUTILITIES__
    ...
    case 5: // Rosenbrock method
      ...
      switch(rb_type)
      {
        ...
        case 3: // FS 1
          ...
          switch(count)
          {
            ...
            case 4: // 4. substep
              ...
              TDatabase::TimeDB->RB_MS_I     =     (4*sqrt(2.0) - 5)/(sqrt(2.0)+1);
            break;
        ...
        case 13: // Alexander: SDIRK(3,4) - order 3
          ...
          if (count==4)  count = 0;
          break;
        case 14: // embedded method of FS 1
          ...
          switch(count)
          {
            case 1: // 1. substep
              ...
              TDatabase::TimeDB->RB_ALPHA_I  =     0.0;
              TDatabase::TimeDB->RB_MS_I      =    0.0;
              TDatabase::TimeDB->RB_M_I     =     1 - b4 - (2 - 5*sqrt(2.0)/4 + b4*sqrt(2.0)/2) - (2 - sqrt(2.0) - b4);
            break;
            case 2: // 2. substep
              TDatabase::TimeDB->RB_A_IJ[0]  =     theta*beta;
              TDatabase::TimeDB->RB_A_IJ[1]  =     theta*alpha;
              TDatabase::TimeDB->RB_ALPHA_I  =     theta;
              TDatabase::TimeDB->RB_MS_I      =    0.0;
              TDatabase::TimeDB->RB_M_I     =     2 - sqrt(2.0) - b4;
            break;
            case 3: // 3. substep
              TDatabase::TimeDB->RB_A_IJ[0]  =     theta*beta;
              TDatabase::TimeDB->RB_A_IJ[1]  =     (1-theta)*alpha;
              ...
              TDatabase::TimeDB->RB_ALPHA_I  =     1-theta;
              TDatabase::TimeDB->RB_MS_I      =    0.0;
              TDatabase::TimeDB->RB_M_I     =     2 - 5*sqrt(2.0)/4 + b4*sqrt(2.0)/2;
            break;
            case 4: // 4. substep
              TDatabase::TimeDB->RB_A_IJ[0]  =     theta*beta;
              TDatabase::TimeDB->RB_A_IJ[1]  =     (1-theta)*alpha;
              ...
              TDatabase::TimeDB->RB_ALPHA_I  =     1.0;
              TDatabase::TimeDB->RB_MS_I      =    0.0;
              TDatabase::TimeDB->RB_M_I     =     (4*sqrt(2.0) - 5)/(sqrt(2.0)+1);
            break;
        ...
        case 15:
          switch(count)
          {
            ...
            case 3: // 1. substep
              TDatabase::TimeDB->RB_A_IJ[0]  =     0.5;
              TDatabase::TimeDB->RB_A_IJ[1]  =     0.0;
              TDatabase::TimeDB->RB_A_IJ[2]  =     0.5;
              TDatabase::TimeDB->RB_ALPHA_I  =     1.0;
              TDatabase::TimeDB->RB_M_I      =    0.0;
              TDatabase::TimeDB->RB_MS_I     =      0.5;
            break;
            case 4: // 1. substep
              TDatabase::TimeDB->RB_A_IJ[0]  =     0.25;
              TDatabase::TimeDB->RB_A_IJ[1]  =     0.5;
              TDatabase::TimeDB->RB_A_IJ[2]  =     0.0;
              TDatabase::TimeDB->RB_A_IJ[3]  =     0.25;
              TDatabase::TimeDB->RB_ALPHA_I  =     1.0;
              TDatabase::TimeDB->RB_M_I      =    0.25;
              TDatabase::TimeDB->RB_MS_I     =      0.0;
            break;
    ...
    switch(TDatabase::TimeDB->RB_TYPE)
      {
        ...
        case 15:
          ...
          break;
        default:
          cout << "This DIRK-TYPE does not exist!" << endl;
          exit(4711);
        }
        break;
    case 7:
