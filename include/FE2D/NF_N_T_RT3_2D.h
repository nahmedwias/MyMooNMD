...
{ (322. - 13.*sqrt(70.))/1800., (322. + 13.*sqrt(70.))/1800., 128./450.,
...
void NF_N_T_RT3_2D_EvalAll(TCollection *, const TBaseCell *Cell,
                           const double *PointValues, double *Functionals)
{
  ...
  else // on a real cell
  {
    ...
    #else
    ErrThrow("NF_N_T_RT3_2D_EvalAll not implemented in 3D");
    #endif
...
void NF_N_T_RT3_2D_EvalEdge(TCollection *, const TBaseCell *Cell, int Joint,
                            const double *PointValues, double *Functionals)
{
...
TNodalFunctional2D *NF_N_T_RT3_2D_Obj = new TNodalFunctional2D
        (NF_N_T_RT3_2D, 24, 4, 34, 5, NF_N_T_RT3_2D_Xi, NF_N_T_RT3_2D_Eta,
