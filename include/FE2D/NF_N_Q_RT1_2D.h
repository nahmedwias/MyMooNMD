...
static double NF_N_Q_RT1_2D_Xi[] =  { 0,   0.5, 0,  -0.5 };
static double NF_N_Q_RT1_2D_Eta[] = {-0.5, 0,   0.5, 0  };
static double NF_N_Q_RT1_2D_T[] = {0};
...
void NF_N_Q_RT1_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint, double *PointValues,
                           double *Functionals)
{
//   static double weights[3] = { 0.5555555555555555555555555555555556,
//                                0.88888888888888888888888888888888889,
...
TNodalFunctional2D *NF_N_Q_RT1_2D_Obj = new TNodalFunctional2D
        (NF_N_Q_RT1_2D, 4, 1, 12, 3, NF_N_Q_RT1_2D_Xi, NF_N_Q_RT1_2D_Eta,
