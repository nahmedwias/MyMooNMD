...
void NF_D_T_P3_2D_EvalAll(TCollection *Coll, TBaseCell *Cell,
...
void NF_D_T_P3_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint,
                           const double *PointValues, double *Functionals)
{
}
...
TNodalFunctional2D *NF_D_T_P3_2D_Obj = new TNodalFunctional2D
        (NF_D_T_P3_2D, 10, 0, 15, 0, NF_D_T_P3_2D_Xi, NF_D_T_P3_2D_Eta,
         nullptr, NF_D_T_P3_2D_EvalAll, NF_D_T_P3_2D_EvalEdge);
