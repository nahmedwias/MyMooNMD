...
void NF_N_T_BDM2_2D_EvalAll(TCollection *, const TBaseCell *Cell,
...
void NF_N_T_BDM2_2D_EvalEdge(TCollection *, const TBaseCell *Cell, int Joint,
                            const double *PointValues, double *Functionals)
{
...
TNodalFunctional2D *NF_N_T_BDM2_2D_Obj = new TNodalFunctional2D
        (NF_N_T_BDM2_2D, 12, 3, 31, 4, NF_N_T_BDM2_2D_Xi, NF_N_T_BDM2_2D_Eta,
