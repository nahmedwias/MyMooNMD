...
static double NF_N_Q_RT2_2D_b = sqrt(3./7. - (2./7.)*sqrt(6./5.)); // 0.33998
// weights for the 1D Gauss quadrature with four points
static double NF_N_Q_RT2_2D_wa = (18. - sqrt(30.)) / 36.; // 0.34785
static double NF_N_Q_RT2_2D_wb = (18. + sqrt(30.)) / 36.; // 0.65215
...
void NF_N_Q_RT2_2D_EvalAll(TCollection *, const TBaseCell *Cell,
...
void NF_N_Q_RT2_2D_EvalEdge(TCollection *, const TBaseCell *Cell, int,
                            const double *PointValues, double *Functionals)
{
...
TNodalFunctional2D *NF_N_Q_RT2_2D_Obj = new TNodalFunctional2D
        (NF_N_Q_RT2_2D, 24, 3, 32, 4, NF_N_Q_RT2_2D_Xi, NF_N_Q_RT2_2D_Eta,
