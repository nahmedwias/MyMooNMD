...
void NF_D_Q_P2_2D_EvalAll(TCollection *Coll, TBaseCell *Cell,
...
void NF_D_Q_P2_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint,
                           const double *PointValues, double *Functionals)
{
}
...
TNodalFunctional2D *NF_D_Q_P2_2D_Obj = new TNodalFunctional2D
        (NF_D_Q_P2_2D, 6, 0, 9, 0, NF_D_Q_P2_2D_Xi, NF_D_Q_P2_2D_Eta,
         NF_D_Q_P2_2D_t, NF_D_Q_P2_2D_EvalAll, nullptr);
