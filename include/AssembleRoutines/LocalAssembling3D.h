...
class LocalAssembling3D
{
  ...
  public:
    ...
    void setAssembleParam(AssembleFctParam3D * assembleFctParam3D)
    {
      AssembleParam = assembleFctParam3D;
    }

    void setAssembleParam_string(std::string assembleFctParam3Dname);
