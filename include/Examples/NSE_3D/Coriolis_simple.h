  ...
  switch(example)
  {
    ...
    case 2:
    {
      ...
      values[0] = std::pow(xx + yy + zz, -0.5*R)
                  *(K*R*x*zz*std::pow(xx + yy, 0.5*R)*sin(R*atan2(y, x))
                    - K*R*y*zz*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
                    + K*xx*y*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
                    + K*y*y*y*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
      ...
      values[1] = K*R*std::pow(xx + yy, 0.5*R)*std::pow(xx + yy + zz, -0.5*R)
                  *(-R*std::pow(x, 3)*y*zz*cos(R*atan2(y, x))
                    - R*xx*yy*zz*sin(R*atan2(y, x))
                    + R*xx*std::pow(z, 4)*sin(R*atan2(y, x))
                    - R*x*std::pow(y, 3)*zz*cos(R*atan2(y, x))
                    - 2*R*x*y*std::pow(z, 4)*cos(R*atan2(y, x))
                    - R*std::pow(y, 4)*zz*sin(R*atan2(y, x))
                    - R*yy*std::pow(z, 4)*sin(R*atan2(y, x))
                    + std::pow(x, 4)*yy*sin(R*atan2(y, x))
                    - std::pow(x, 4)*zz*sin(R*atan2(y, x))
                    + 3*std::pow(x, 3)*y*zz*cos(R*atan2(y, x))
                    + 2*xx*std::pow(y, 4)*sin(R*atan2(y, x))
                    + xx*yy*zz*sin(R*atan2(y, x))
                    - xx*std::pow(z, 4)*sin(R*atan2(y, x))
                    + 3*x*std::pow(y, 3)*zz*cos(R*atan2(y, x))
                    + 2*x*y*std::pow(z, 4)*cos(R*atan2(y, x))
                    + std::pow(y, 6)*sin(R*atan2(y, x))
                    + 2*std::pow(y, 4)*zz*sin(R*atan2(y, x))
                    + yy*std::pow(z, 4)*sin(R*atan2(y, x)))
                      ...
                      *(K*R*x*zz*std::pow(xx + yy, 0.5*R)*sin(R*atan2(y, x))
                      ...
                      + std::pow(xx + yy + zz, R + 1)
                        *(-K*R*std::pow(xx + yy, 0.5*R)*(xx + yy + zz)
                          *(R*xx*zz*cos(R*atan2(y, x))
                          + 2*R*x*y*zz*sin(R*atan2(y, x))
                          - R*yy*zz*cos(R*atan2(y, x))
                          - std::pow(x, 3)*y*sin(R*atan2(y, x))
                          + xx*yy*cos(R*atan2(y, x))
                          - x*std::pow(y, 3)*sin(R*atan2(y, x))
                          + std::pow(y, 4)*cos(R*atan2(y, x)))
                        + R*omega*yy*std::pow(xx + yy, 2)
                          *std::pow(xx + yy + zz, 0.5*R)
                        + (xx + yy)*(xx + yy + zz)
                          *(K*R*zz*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
                            - K*xx*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
                            - 3*K*yy*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
      ...
      values[3] = K*R*z*std::pow(xx + yy, 0.5*R - 1)
                  ...
                  *(-R*x*zz*sin(R*atan2(y, x))
                  + R*y*zz*cos(R*atan2(y, x)) - xx*y*cos(R*atan2(y, x))
                  - std::pow(y, 3)*cos(R*atan2(y, x))
                  - 2*(-x*sin(R*atan2(y, x)) + y*cos(R*atan2(y, x)))
                    *(xx + yy + zz));
      values[4] = -K*R*std::pow(xx + yy, 0.5*R)*std::pow(xx + yy + zz, -0.5*R)
                   *(std::pow(R, 2)*x*zz*sin(R*atan2(y, x))
                    - std::pow(R, 2)*y*zz*cos(R*atan2(y, x))
                    + R*xx*y*cos(R*atan2(y, x))
                    + 3*R*x*zz*sin(R*atan2(y, x))
                    + R*std::pow(y, 3)*cos(R*atan2(y, x))
                    - 3*R*y*zz*cos(R*atan2(y, x))
                    + 3*xx*y*cos(R*atan2(y, x))
                    + 3*std::pow(y, 3)*cos(R*atan2(y, x)))
...
void ExactU2(double x, double y,  double z, double *values)
{
  switch(example)
  {
    ...
    case 2:
    {
      ...
      double zz = z*z;
      values[0] = std::pow(xx + yy + zz, -0.5*R)
                  *(K*R*x*zz*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
                    + K*R*y*zz*std::pow(xx + yy, 0.5*R)*sin(R*atan2(y, x))
                    - K*std::pow(x, 3)*std::pow(xx + yy, 0.5*R)
                      *cos(R*atan2(y, x))
                    - K*x*yy*std::pow(xx + yy, 0.5*R)*cos(R*atan2(y, x))
      ...
      values[2] = K*R*std::pow(xx + yy, 0.5*R)*std::pow(xx + yy + zz, -0.5*R)
                  *(-R*std::pow(x, 4)*zz*sin(R*atan2(y, x))
                    ...
                    + 2*R*x*y*std::pow(z, 4)*cos(R*atan2(y, x))
                    + R*yy*std::pow(z, 4)*sin(R*atan2(y, x))
                    + std::pow(x, 6)*sin(R*atan2(y, x))
                    + 2*std::pow(x, 4)*yy*sin(R*atan2(y, x))
                    + 2*std::pow(x, 4)*zz*sin(R*atan2(y, x))
                    - 3*std::pow(x, 3)*y*zz*cos(R*atan2(y, x))
                    + xx*std::pow(y, 4)*sin(R*atan2(y, x))
                    + xx*yy*zz*sin(R*atan2(y, x))
                    + xx*std::pow(z, 4)*sin(R*atan2(y, x))
                    - 3*x*std::pow(y, 3)*zz*cos(R*atan2(y, x))
                    - 2*x*y*std::pow(z, 4)*cos(R*atan2(y, x))
                    - std::pow(y, 4)*zz*sin(R*atan2(y, x))
                    - yy*std::pow(z, 4)*sin(R*atan2(y, x)))
                  /(std::pow(x, 6) + 3*std::pow(x, 4)*yy + std::pow(x, 4)*zz
                    + 3*xx*std::pow(y, 4) + 2*xx*yy*zz + std::pow(y, 6)
                    + std::pow(y, 4)*zz);
      values[3] = K*R*z*std::pow(xx + yy, 0.5*R - 1)
                  ...
                  *(-R*x*zz*cos(R*atan2(y, x))
                    - R*y*zz*sin(R*atan2(y, x))
                    + std::pow(x, 3)*cos(R*atan2(y, x))
                    + x*yy*cos(R*atan2(y, x)) + 2*(x*cos(R*atan2(y, x))
                    + y*sin(R*atan2(y, x)))*(xx + yy + zz));
      values[4] = K*R*std::pow(xx + yy, 0.5*R)*std::pow(xx + yy + zz, -0.5*R)
                  *(-std::pow(R, 2)*x*zz*cos(R*atan2(y, x))
                    - std::pow(R, 2)*y*zz*sin(R*atan2(y, x))
                    + R*std::pow(x, 3)*cos(R*atan2(y, x))
                    + R*x*yy*cos(R*atan2(y, x)) - 3*R*x*zz*cos(R*atan2(y, x))
                    - 3*R*y*zz*sin(R*atan2(y, x))
                    + 3*std::pow(x, 3)*cos(R*atan2(y, x))
                    + 3*x*yy*cos(R*atan2(y, x)))
                  /(std::pow(x, 4) + 2*xx*yy + xx*zz + std::pow(y, 4) + yy*zz);
      break;
    }
    default:
    ...
    case 2:
    {
      ...
      values[1] = K*std::pow(R, 2)*z
                  *(x*std::pow(xx + yy, 0.5*R + 1)*std::pow(xx + yy + zz, 0.5*R)
                    *sin(R*atan2(y, x))
                    + std::pow(xx + yy, 0.5*R)*(-x*sin(R*atan2(y, x))
                    + y*cos(R*atan2(y, x)))*std::pow(xx + yy + zz, 0.5*R
                    + 1))
      ...
      values[2] = K*std::pow(R, 2)*z
                  *(y*std::pow(xx + yy, 0.5*R + 1)*std::pow(xx + yy + zz, 0.5*R)
                    *sin(R*atan2(y, x))
                    - std::pow(xx + yy, 0.5*R)
                      *(x*cos(R*atan2(y, x)) + y*sin(R*atan2(y, x)))
                      *std::pow(xx + yy + zz, 0.5*R + 1)
                   )*std::pow(xx + yy + zz, -R - 1)/(xx + yy);
      values[3] = -K*R*std::pow(xx + yy, 0.5*R)
                   *std::pow(xx + yy + zz, -0.5*R - 1)
                   *(-R*zz + xx + yy + zz)*sin(R*atan2(y, x));
