...
//   values[0] = exp(-((x-264.792889)*(x-264.792889)+(y-144.038695)*(y-144.038695)+(z+10.472588)*(z+10.472588))/20); 
}
...
//==============Breast Geometry - breast2.mesh===============================================================================
//   values[0] = 1- exp(-((x-264.792889)*(x-264.792889)+(y-144.038695)*(y-144.038695)+(z+10.472588)*(z+10.472588))/20);   
}
...
//     values[0] = 5 * exp(-((x-239)*(x-239)+(y-24)*(y-24)+(z-167)*(z-167))/20);
   
//==============Breast Geometry - breast2.mesh==================================================================================
//   values[0] = 0.5 * exp(-((x-264.792889)*(x-264.792889)+(y-144.038695)*(y-144.038695)+(z+10.472588)*(z+10.472588))/20); 
}
...
{
  double eps= 0./TDatabase::ParamDB->RE_NR;
  int i;
  double *coeff;                                  // *param;
