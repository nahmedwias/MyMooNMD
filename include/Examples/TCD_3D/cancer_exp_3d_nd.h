...
void V_Exact(double x, double y, double z, double *values)
{
 values[0] =  0;
}

void W_Exact(double x, double y, double z, double *values)
{
  values[0] =  0;
}
...
//===============cube=============================================================================================
//        double temp; 
//          temp = ((x-0.5)*(x-0.5)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5));
//   
//    if (temp >0.1)
//     { values[0] = 0.; }
//    else
//     { values[0] = exp(-temp/0.01);}
...
//==============Breast Geometry=====================================================================================
  //values[0] = exp(-((x-286.530470)*(x-286.530470)+(y-34.297560)*(y-34.297560)+(z-162.509553)*(z-162.509553))/20); 
    /* values[0] = exp(-((x-239)*(x-239)+(y-24)*(y-24)+(z-167)*(z-167))/20); */
    
     values[0] = exp(-((x-240)*(x-240)+(y-50)*(y-50)+(z-147)*(z-147))/20); 
    
//    values[0] = exp(-((x-225)*(x-225)+(y-5)*(y-5)+(z-150)*(z-150))/100);    //near boundary
// values[0] = exp(-((x-230)*(x-230)+(y+30)*(y+30)+(z-177)*(z-177))/100);    //on boundary
     
     
//==============Breast Geometry - breast2.mesh========================================================================
//   values[0] =  exp(-((x-264.792889)*(x-264.792889)+(y-144.038695)*(y-144.038695)+(z+10.472588)*(z+10.472588))/100); 
  
}

void V_InitialCondition(double x, double y, double z, double *values)
{ 
//===============cube==================================================================================================== 
//       double temp; 
//        temp = ((x-0.5)*(x-0.5)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5));
...
//==============Breast Geometry=============================================================================================
  // values[0] = 1 - exp(-((x-286.530470)*(x-286.530470)+(y-34.297560)*(y-34.297560)+(z-162.509553)*(z-162.509553))/20); 
  //    values[0] = 1- exp(-((x-239)*(x-239)+(y-24)*(y-24)+(z-167)*(z-167))/20); 
  
  
   values[0] = 1 - 0.5 * exp(-((x-240)*(x-240)+(y-50)*(y-50)+(z-147)*(z-147))/20); 
   
//==============Breast Geometry - breast2.mesh===============================================================================
//     values[0] = 1- 0.5* exp(-((x-264.792889)*(x-264.792889)+(y-144.038695)*(y-144.038695)+(z+10.472588)*(z+10.472588))/100);  
//          values[0] = 1- 0.5 * exp(-((x-268)*(x-268)+(y-165)*(y-165)+(z+10.)*(z+10.))/20); 
      
}

void W_InitialCondition(double x, double y, double z, double *values)
{
//===============cube========================================================================================================
//      double temp; 
//          temp = ((x-0.5)*(x-0.5)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5));
...
//==============Breast Geometry=================================================================================================
     //  values[0] = 5 * exp(-((x-286.530470)*(x-286.530470)+(y-34.297560)*(y-34.297560)+(z-162.509553)*(z-162.509553))/20); 
    //   values[0] = 0.5 * exp(-((x-239)*(x-239)+(y-24)*(y-24)+(z-167)*(z-167))/20);
  
  
   values[0] =   0.5 * exp(-((x-240)*(x-240)+(y-50)*(y-50)+(z-147)*(z-147))/20);   
   
//==============Breast Geometry - breast2.mesh==================================================================================
//      values[0] = 0.5 * exp(-((x-264.792889)*(x-264.792889)+(y-144.038695)*(y-144.038695)+(z+10.472588)*(z+10.472588))/100); 
...
void W_BilinearCoeffs(int n_points, double *X, double *Y, double *Z,
               double **parameters, double **coeffs)
{
  double eps= 5./TDatabase::ParamDB->RE_NR;
  int i;
  double *coeff;                                  // *param;
  double x, y, z, c, a[3], b[3], s[3], h;
  double t = TDatabase::TimeDB->CURRENTTIME;
