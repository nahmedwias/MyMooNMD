...
void compute_drag_lift_pdiff(Brinkman3D& brinkman3d)
{
#ifdef _MPI
  MPI_Comm comm = MPI_COMM_WORLD;
  int my_rank;
  ...
  const TFEVectFunct3D& u(brinkman3d.get_velocity());
  TFEFunction3D& p(brinkman3d.get_pressure()); //I want this const!!!
