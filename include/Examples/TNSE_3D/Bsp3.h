...
void U1BoundValue_diff(double, double y, double z, double &value)
{
double t=TDatabase::TimeDB->CURRENTTIME;
value = -exp(-t)*(y*y+z);
}

void U2BoundValue_diff(double x, double, double z, double &value)
{
double t=TDatabase::TimeDB->CURRENTTIME;
value = 4*t*t*t*(x-2*z*z);
}

void U3BoundValue_diff(double x, double y, double, double &value)
{
double t=TDatabase::TimeDB->CURRENTTIME;
