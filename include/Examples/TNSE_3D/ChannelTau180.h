...
//       &&(CurrentElement!=C_Q1_3D_H_A)&&(CurrentElement!=C_Q1_3D_H_M))
//     {
...
//       {
//         case 8:                                   // for the case k=1 --> Q_1 elements
//         {
...
//   sum_values_per_layer_u1 = new double[13*N_z_layers];
//   memset(sum_values_per_layer_u1,0,13*N_z_layers*SizeOfDouble);
// 
...
//     {
//       // check if coordinate of d.o.f. belongs to the layer
...
//   {
//     average_count++;
//     OutPut(T << " average no. " << average_count << endl);
//     for (i=0;i<N_z_layers;i++)
//     {
//       // <<u>_s>_t
//       mean_velocity_u1[i] = mean_velocity_u1[i]
//         + (sum_values_per_layer_u1[i] - mean_velocity_u1[i])/average_count;
//       mean_velocity_u2[i] = mean_velocity_u2[i]
//         + (sum_values_per_layer_u2[i] - mean_velocity_u2[i])/average_count;
//       mean_velocity_u3[i] = mean_velocity_u3[i]
//         + (sum_values_per_layer_u3[i] - mean_velocity_u3[i])/average_count;
//       //  <<u u>_s>_t
//       R_xx[i]  =  R_xx[i] + (sum_values_per_layer_xx[i] - R_xx[i])/average_count;
//       R_yy[i]  =  R_yy[i] + (sum_values_per_layer_yy[i] - R_yy[i])/average_count;
//       R_zz[i]  =  R_zz[i] + (sum_values_per_layer_zz[i] - R_zz[i])/average_count;
//       R_xy[i]  =  R_xy[i] + (sum_values_per_layer_xy[i] - R_xy[i])/average_count;
//       R_xz[i]  =  R_xz[i] + (sum_values_per_layer_xz[i] - R_xz[i])/average_count;
//       R_yz[i]  =  R_yz[i] + (sum_values_per_layer_yz[i] - R_yz[i])/average_count;
//     }
...
//         + (d_mean_velocity_u1[i]-dmean_velocity_u1[i])/average_count;
//     }
...
//     for (i=0;i<N_z_layers;i++)
//     {
//       rms_values_per_layer_u1[i] = 2.0*(R_xx[i]- mean_velocity_u1[i] * mean_velocity_u1[i] )/3.0;
//       rms_values_per_layer_u1[i] -= (R_yy[i]- mean_velocity_u2[i] * mean_velocity_u2[i] )/3.0;
//       rms_values_per_layer_u1[i] -= (R_zz[i]- mean_velocity_u3[i] * mean_velocity_u3[i] )/3.0;
//       rms_values_per_layer_u2[i] = 2.0*(R_yy[i]- mean_velocity_u2[i] * mean_velocity_u2[i] )/3.0;
//       rms_values_per_layer_u2[i] -= (R_xx[i]- mean_velocity_u1[i] * mean_velocity_u1[i] )/3.0;
//       rms_values_per_layer_u2[i] -= (R_zz[i]- mean_velocity_u3[i] * mean_velocity_u3[i] )/3.0;
//       rms_values_per_layer_u3[i] = 2.0*(R_zz[i]- mean_velocity_u3[i] * mean_velocity_u3[i] )/3.0;
//       rms_values_per_layer_u3[i] -= (R_xx[i]- mean_velocity_u1[i] * mean_velocity_u1[i] )/3.0;
//       rms_values_per_layer_u3[i] -= (R_yy[i]- mean_velocity_u2[i] * mean_velocity_u2[i] )/3.0;
//     }
//     
...
//         " " << setw(8) << coord_z_layers[i] <<
//         " " << setw(8) <<  RE*(1-fabs(1-coord_z_layers[i])) <<
//         " rms_u "<<setw(8)<<sqrt(fabs(rms_values_per_layer_u1[i])) <<
//         " rms_v "<<setw(8)<<sqrt(fabs(rms_values_per_layer_u3[i]))   <<
//         " rms_w "<<setw(8)<<sqrt(fabs(rms_values_per_layer_u2[i]))   <<
...
//         " R_uv2 "<<setw(8)<<(R_xz[i]- mean_velocity_u1[i]* mean_velocity_u3[i])/(u_tau*u_tau) <<
//         " R_uw2 "<<setw(8)<<(R_xy[i]- mean_velocity_u1[i]* mean_velocity_u2[i])/(u_tau*u_tau) <<
//         " R_vw2 "<<setw(8)<<(R_yz[i]- mean_velocity_u2[i]* mean_velocity_u3[i])/(u_tau*u_tau) <<
//         endl);
//       R_uw_abs += fabs((R_xy[i]- mean_velocity_u1[i]* mean_velocity_u2[i])/(u_tau*u_tau));
//       R_vw_abs += fabs((R_yz[i]- mean_velocity_u2[i]* mean_velocity_u3[i])/(u_tau*u_tau));
//     }
//     OutPut(T << " u_tau = " << u_tau << " zero statistics : R_uw " << setw(8)<< R_uw_abs/N_z_layers <<
...
//     //bulk_velocity += 0.5*(sum_values_per_layer_u1[i+1]+sum_values_per_layer_u1[i])*(coord_z_layers[i+1]-coord_z_layers[i]);
//   }
//   bulk_velocity /= 2.0;
// 
