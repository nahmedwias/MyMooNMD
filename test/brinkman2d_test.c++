...
{//Not yet Nitsche (normals)
  ...
  //--------------------------------------------------------------------------------------------------------------------↲
   ...
   // TDatabase::ParamDB->sign_MatrixBi=-1;
    ...
    //TDatabase::ParamDB->INTERNAL_PROJECT_PRESSURE = 1;↲                       
    Output::print("\nstarting with Brinkman2D on TwoTriangles, P2/P1, with Dirichlet and Neumann bcs and with visc_eff=visc=0.004, perm= 1");
    reference_errors = {{0.0054680957600273, 0.1443805008035, 5.246987770953e-05, 0.00061083280165159}};
    check_brinkman2d(domain, db, 2,1, reference_errors); 
}
...
{//Not yet Nitsche (normals)
  ...
  //  TDatabase::ParamDB->sign_MatrixBi = -1;
    ...
    reference_errors = {{0.049354569383435, 0.20428824240268, 9.3291684594421e-05, 0.0010263458082476}};
    check_brinkman2d(domain, db, 2,1, reference_errors); 
...
{//Not yet Nitsche (normals)
  ...
  //--------------------------------------------------------------------------------------------------------------------↲
   db["example"] = 1; // Poiseuille_Hannukainen
    ...
    //TDatabase::ParamDB->INT1.234700145656816.7500215391470.018674085154587ERNAL_PROJECT_PRESSURE = 1;↲                       
    Output::print("\nstarting with Brinkman2D on TwoTriangles, P1/P1-Stab (GLS), Dirichlet and Neumann bcs and with visc_eff=visc=0.004, perm= 1");
    reference_errors = {{ 1.2347001456568, 16.750021539147,0.018674085154587, 0.22010507412489}};
    check_brinkman2d(domain, db, 1, 1, reference_errors); 
...
{//Not yet Nitsche (normals)
  ...
  //--------------------------------------------------------------------------------------------------------------------↲
    ...
    //TDatabase::ParamDB->INT1.234700145656816.7500215391470.018674085154587ERNAL_PROJECT_PRESSURE = 1;↲                       
    Output::print("\nstarting with Brinkman2D on TwoTriangles, P1/P1-Stab (GLS), penalty-free non-symmetric Nitsche approach and Neumann bcs and with visc_eff=visc=0.004, perm= 1");
    reference_errors = {{9.599443219491, 23.384929664058, 0.022130923948982, 0.27177748647831}};
    check_brinkman2d(domain, db, 1, 1, reference_errors); 
