...
int main(int argc, char* argv[])
{
  ...
  if(my_rank==0)
  {
    ...
    Output::info("Time_NSE3D_Merged", "MPI, using ", size, " processes");
  }
#else
  int my_rank = 0;
  Output::print("<<<<< Running ParMooN: NSE3D Main Program >>>>>");
  Output::info("Time_NSE3D_Merged", "SEQUENTIAL (or OMP...)");
#endif
  ...
  // Construct an object of the Time_NSE3D_Merged-problem type.
#ifdef _MPI
