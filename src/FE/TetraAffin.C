...
*/
  /*  for(i=0;i<N_Sets;i++)
  {
    if(Needs2ndDer[i])
    {
      ...
      refvaluesD20=TFEDatabase3D::GetRefElementValues(BaseFunct, QuadFormula, D20);
      origvaluesD20=TFEDatabase3D::GetOrigElementValues(BaseFunct, D20);
  
      refvaluesD11=TFEDatabase3D::GetRefElementValues(BaseFunct, QuadFormula, D11);
      origvaluesD11=TFEDatabase3D::GetOrigElementValues(BaseFunct, D11);
  
      refvaluesD02=TFEDatabase3D::GetRefElementValues(BaseFunct, QuadFormula, D02);
      origvaluesD02=TFEDatabase3D::GetOrigElementValues(BaseFunct, D02);
