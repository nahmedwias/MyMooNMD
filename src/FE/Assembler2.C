...
void Assembler2::Assemble2D(int n_fespaces, const TFESpace2D** fespaces, int n_sqmatrices,
                            ...
                            int AssemblePhaseID)
{
  ...
  loop_over_cells(fespaces, AssemblePhaseID, n_fespaces,
                    ...
                    N_BaseFunct,  BaseFuncts,GlobalNumbers, BeginIndex);
...
void Assembler2::loop_over_cells(const TFESpace2D** fespaces, int AssemblePhaseID, int n_fespaces,
                                 LocalAssembling2D& la,  int n_sqmatrices, double ***LocMatrices,
