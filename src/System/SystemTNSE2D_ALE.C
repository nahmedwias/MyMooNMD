...
TSystemTNSE2D_ALE::TSystemTNSE2D_ALE(TFESpace2D *velocity_fespace, TFESpace2D *presssure_fespace, TFEVectFunct2D *Velocity, 
                                           ...
                                           : TSystemTNSE2D(velocity_fespace, presssure_fespace, Velocity, p, disctype, nsetype, solver ,Projection_space)
{
  char WString[] = "w";  
  TFESpace2D *fesp[1]; 
...
void TSystemTNSE2D_ALE::Assemble(double *sol, double *rhs)
{
