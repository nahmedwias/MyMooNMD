...
// sorry I am here because of new structure and POD stuff 
template<int d>
...
template void TCDRhs<2>(
  double Mult, double *coeff, double *param, double hK, double**OrigValues, 
  int *N_BaseFuncts, double ***LocMatrices, double **LocRhs);
template void GradGrad<2>(double Mult, double *coeff, double *param, double hK,  
...
template void TCDRhs<3>(
  double Mult, double *coeff, double *param, double hK, double**OrigValues, 
  int *N_BaseFuncts, double ***LocMatrices, double **LocRhs);
template void GradGrad<3>(double Mult, double *coeff, double *param, double hK,
  double**OrigValues, int *N_BaseFuncts, double ***LocMatrices, double **LocRhs);
