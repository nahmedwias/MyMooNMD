...
static const int DatChildVertex[][3] =
                 {{3, 0, 1}, {3, 1, 2}, {3, 2, 0}};

static const int DatVertexChild[][3] =
                 {{2, 0}, {0, 1}, {1, 2}, {2, 1, 0}};

static const int DatVertexChildIndex[][3] =
                 { {2, 1}, {2, 1}, {2, 1}, {0, 0, 0}};

static const int DatVertexChildLen[] = {2, 2, 2, 3 };

static const int DatChildEdge[][3] =
                 { {3, 0, 4}, {4, 1, 5}, {5, 2, 3} };
...
static const int DatInteriorVertexOfEdge[][0] = {{}, {}, {} };
