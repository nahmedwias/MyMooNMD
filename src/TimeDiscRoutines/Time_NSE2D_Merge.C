...
ParameterDatabase get_default_TNSE2D_parameters()
{
  ...
  //Time_NSE2D_Merge requires a nonlinear iteration, set up a nonlinit_database and merge
...
Time_NSE2D_Merge::System_per_grid::System_per_grid(const Example_TimeNSE2D& example,
                  TCollection& coll, std::pair< int, int > order,
                  Time_NSE2D_Merge::Matrix type)
...
/**************************************************************************** */
Time_NSE2D_Merge::Time_NSE2D_Merge(const TDomain& domain,
           const ParameterDatabase& param_db, int reference_id)
: Time_NSE2D_Merge(domain, param_db, Example_TimeNSE2D(param_db), reference_id)
{
}
...
/**************************************************************************** */
void Time_NSE2D_Merge::set_parameters()
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::get_velocity_pressure_orders(std::pair< int, int > &velo_pres_order)
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::assemble_initial_time()
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::assemble_matrices_rhs(unsigned int it_counter)
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::call_assembling_routine(Time_NSE2D_Merge::System_per_grid& s,
...
/**************************************************************************** */
void Time_NSE2D_Merge::set_arrays(Time_NSE2D_Merge::System_per_grid& s,
...
/**************************************************************************** */
void Time_NSE2D_Merge::restrict_function()
{
...
/**************************************************************************** */
bool Time_NSE2D_Merge::imex_scheme(bool print_info)
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::modify_slip_bc(bool BT_Mass, bool slip_A_nl)
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::prepared_postprocessing(TCollection *coll)
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::assemble_rhs_nonlinear()
{
  // initialize the rhs from the time discretization
  rhs_from_time_disc = this->systems.front().rhs;
  rhs_from_time_disc.reset();
...
/**************************************************************************** */
void Time_NSE2D_Merge::update_matrices_lps(System_per_grid &s)
{
  std::vector<std::shared_ptr<FEMatrix>> blocks;
  blocks = s.matrix.get_blocks_uniquely();
...
/**************************************************************************** */
bool Time_NSE2D_Merge::stopIte(unsigned int it_counter)
{
...
/**************************************************************************** */
void Time_NSE2D_Merge::output(int m)
{
  System_per_grid& s = this->systems.front();
...
/**************************************************************************** */
void Time_NSE2D_Merge::output_problem_size_info() const
{
...
/**************************************************************************** */
std::array< double, int(6) > Time_NSE2D_Merge::get_errors()
{
...
double Time_NSE2D_Merge::getFullResidual() const
{
