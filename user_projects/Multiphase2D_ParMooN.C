...
//  cd_db.merge(parmoon_db,true);
  ...
  //==================================ALL INITIALIZING OBJECTS FOR MULTIPHASE
  ...
  rho_vector.scale(rho1-rho2); mu_vector.scale(mu1-mu2);
  ...
  //==================================END INITIALIZING OBJECTS FOR MULTIPHASE
...
//    nse2d.update_solution(cd2d.get_solution());
    ...
    rho_vect.scale(rho1-rho2); mu_vect.scale(mu1-mu2);
