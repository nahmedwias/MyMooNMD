...
#include "StokesDarcy2DAdaptive/StoDa2DRefinementStrategy.h"
...
{
    {
        ...
        const double solution_strategy = TDatabase::ParamDB->StoDa_solutionStrategy;
        ...
        for (int curr_level = 0; curr_level < LEVELS; curr_level++) {
            ...
            * ========================================================================*/
            ...
            /**
             * initialize estimators and refinement strategy
             */
            TAuxParam2D aux;
            CDErrorEstimator2D cdErrorEstimator2D (d_problems.begin()->second->get_example(), TDatabase::ParamDB->ADAPTIVE_REFINEMENT_CRITERION);
            cdErrorEstimator2D.setConformGrid(true);

            NSEErrorEstimator2D nseErrorEstimator2D (ns_problems.begin()->second->get_example(), TDatabase::ParamDB->ADAPTIVE_REFINEMENT_CRITERION, false);
            nseErrorEstimator2D.setConformGrid(true);
