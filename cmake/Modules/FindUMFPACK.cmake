...
if(NOT UMFPACK_FOUND)
  ...
  if(NOT UMFPACK_LIBRARY)
    ...
    find_library(UMFPACK_LIBRARY NAMES umfpack_${ARCH} PATHS ${PARMOON_EXTLIB_PATH}/UMFPACK/Lib) 
    get_filename_component(UMFPACK_LIBDIR ${UMFPACK_LIBRARY} PATH)
    find_library(UMFPACK_LIBRARY_SUITESE NAMES suitesparseconfig_${ARCH} PATHS ${UMFPACK_LIBDIR})
  ...
  if(UMFPACK_LIBRARY)  
    ...
    if(UMFPACK_LIBRARY_SUITESE )
      set(UMFPACK_LIBRARY  ${UMFPACK_LIBRARY} ${UMFPACK_LIBRARY_SUITESE} ) 
    else(UMFPACK_LIBRARY_SUITESE)
#       if(NOT SCALAPACK_LIB)
#        message("UMFPACK found in system but scalapack not found in the search path")
#       endif()
#        if(NOT PARMETIS_LIB)
#        message("UMFPACK found in system but parmetis not found in the search path")
#       endif()
#       if(NOT METIS_LIB)
#        message("UMFPACK found in system but metis not found in the search path")
#       endif()      
      set(UMFPACK_LIBRARY FALSE)
    endif(UMFPACK_LIBRARY_SUITESE )
