...
if(NOT LAPACK_FOUND)
    find_library(SCALAPACK_LIBRARY NAMES scalapack_${ARCH} PATHS ${PARMOON_EXTLIB_PATH}/MPIBLACS) 
    find_library(BLACS_LIBRARY NAMES blacs_MPI_${ARCH}-0 PATHS ${PARMOON_EXTLIB_PATH}/MPIBLACS)     
    find_library(BLACS_F77LIBRARY NAMES blacsF77init_MPI_${ARCH}-0 PATHS ${PARMOON_EXTLIB_PATH}/MPIBLACS) 
