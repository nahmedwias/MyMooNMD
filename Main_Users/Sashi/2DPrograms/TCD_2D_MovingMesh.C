...
int main(int argc, char* argv[])
{
  ...
  MatVecProc *MatVect;
  DefectProc *Defect;
  TDiscreteForm2D *DiscreteForm, *DiscreteFormGrid;
...
//   char Mass[] = "Mass";
 ...
 TDatabase::ParamDB->P6=0;
  ...
  //======================================================================
   ...
   InitializeDiscreteForms_ScalarMoving(DiscreteFormMatrixMARhs, DiscreteFormGrid, DiscreteFormMatrixMARhs_SUPG,
