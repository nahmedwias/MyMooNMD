                     ...
                     )
{
  ...
  TBoundPart *BoundPart;
  TBoundComp *BoundComp;
  TBdLine *UpdateSlipBound, *UpdateAxialBound, *UpdateAxialBoundTop;
...
// ====================================================================== 
  ...
  S_BX = new double[N_MovVert[2]];
  S_BY = new double[N_MovVert[2]];
  
  
  for(i=0;i<N_MovVert[2];i++)
    MovBoundVert[2][i]->GetCoords(S_BX[i], S_BY[i]);
...
//   TriaReMeshGen(Domain, N_MovVert[2], S_BX, S_BY);
